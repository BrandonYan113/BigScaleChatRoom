...
def gen_labels_crowd(data_root, label_root, ann_root, train=False):
    mkdirs(label_root)
...
if __name__ == '__main__':
    ...
    label_val = 'D:/data/crowdhuman_no_id/labels_with_ids/val'
    ann_val = 'D:\A\CrowdHuman/annotation_val.odgt'

    label_train = 'D:/data/crowdhuman_no_id/labels_with_ids/train'
